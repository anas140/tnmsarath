                    ...
                    ?>
																<tr>
																   ...
																   <input name="status-change" id="status_change" data-status="<?php echo $post->slider_status;?>" data-id=<?php echo $post->slider_id;?> type="checkbox" data-size="small" data-on-color="success" data-off-color="warning" data-on-text="ON" data-off-text="OFF" <?php echo $status_state?> /> 
                                                                    ...
                                                                    <td><?php echo  $post->slider_postedon;?></td>
																   <td>
                                                                   <a  href="<?php echo base_url();?>admin/home/slider_edit/<?php echo $post->slider_id;?>"><img src="<?php echo base_url(); ?>assets/images/pencil.png"></a>
																  <a data-toggle="modal" href="#Delete_Log" class="delete_option" data-id="<?php echo $post->slider_id;?>"><img src="<?php echo base_url(); ?>assets/images/delete.png"></a>
																   </td>
