                          ...
                          <!--           <ul class="pcoded-submenu">
                                 ...
                                 <li class="">
                                    <a href="<?php echo base_url();?>admin/home/about" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext">About Success Valley</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
                                   ...
                                   <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                                        <span class="pcoded-mtext">Manage Events</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                       <li class="">
                                    ...
                                    <a href="<?php echo base_url();?>admin/home/events" class="waves-effect waves-dark">
                                       ...
                                       <li class="">
                                    <a href="<?php echo base_url();?>admin/home/booked_events" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layout-cta-right"></i><b>N</b></span>
                                        <span class="pcoded-mtext">Booked Events</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
